...
* `git clone git@github.com:rumblex/angularattack2016-equiangular.git`

* `cd angularattack2016-equiangular`
...
If receive the error message `"You do not have permission to publish to equiangular.2016.angularattack.io"`, it might mean another team member has already deployed your project to Surge. Ask them to run the next step to give you access.

### Step 3) Add Your Team Members to Surge

* `surge . --add lucas.garswood@gmail.com,a@avm.name,korobochka191@gmail.com`
